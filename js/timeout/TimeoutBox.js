...
const texts = {
  ...
  paragraph:
    'Det ser ut som du har vært inaktiv en stund. Av sikkerhetsgrunner kommer vi om kort til å logge deg ut dersom du ikke ønsker å bli på siden',
  ...
  return (
    <Modal isOpen={brukerSnartUtlogget} closeButton={false} contentLabel={texts.title}>
      ...
      <div className="knapperad knapperad--forrigeNeste">
        ...
        <div className="knapperad__element">
          <a className="knapp" href="/esso/logout">
            {texts.buttonLogout}
          </a>
        </div>
      </div>
