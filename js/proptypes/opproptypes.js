...
export const alleOppfolgingsdialogerAgPt = PropTypes.shape({
    henter: PropTypes.bool,
    hentet: PropTypes.bool,
    hentingFeilet: PropTypes.bool,
});

export const oppfolgingsdialogerAgPt = PropTypes.shape({
...
export const avbrytdialogReducerPt = PropTypes.shape({
