...
const Snakkeboble = ({ initialer, topp, children, hoyre }) => {
    ...
    return (<div className={classNames}>
        <i className="snakkeboble__ikon snakkeboble__ikon--initialer">
            {initialer}
        </i>
...
export class KommentarListeElement extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.kommentar.id === nextProps.kommentarReducer.feiletKommentarId &&
            nextProps.elementId === nextProps.kommentarReducer.feiletTiltakId &&
            nextProps.kommentarReducer.slettingFeilet && nextProps.kommentarReducer.slettingFeilet !== this.props.kommentarReducer.slettingFeilet) {
