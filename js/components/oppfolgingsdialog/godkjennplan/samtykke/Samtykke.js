...
class Samtykke extends Component {
  ...
  sendSamtykke() {
    ...
    this.props.sendSamtykke(
      oppfolgingsdialog.id,
      this.state.samtykke,
      oppfolgingsdialog.arbeidstaker.fnr,
      erArbeidstakerEgenLeder(oppfolgingsdialog)
    );
  }
      ...
      <div className="panel blokk">
        ...
        <div className="knapperad">
          <div className="knapperad__element">
            <Hovedknapp htmlType="submit" onClick={this.sendSamtykke} disabled={this.state.samtykke === null}>
              {texts.buttonSubmit}
            </Hovedknapp>
          </div>
        </div>
