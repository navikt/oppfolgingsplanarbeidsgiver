    ...
    <div className="knapperad knapperad--justervenstre">
      ...
      <div className="knapperad__element godkjent-knapp">
        <Hovedknapp
          ...
          autoFocus
          onClick={() => {
            godkjennPlan(oppfolgingsdialog.id, null, true, oppfolgingsdialog.arbeidstaker.fnr, delMedNav);
          }}
        >
...
const GodkjennPlanAvslaattOgGodkjent = ({ oppfolgingsplan, godkjennPlan, avvisDialog }) => {
  ...
  return (
    <div className="godkjennPlanAvslaattOgGodkjent">
      ...
      >
        <div>
          <p>{`${oppfolgingsplan.arbeidstaker.navn}${texts.godkjennPlanAvslaattOgGodkjent.paragraphInfoWho}`}</p>
          ...
          <GodkjennPlanMottattKnapper oppfolgingsdialog={oppfolgingsplan} godkjennPlan={godkjennPlan} />
        </div>
      </OppfolgingsplanInnholdboks>
    </div>
  );
