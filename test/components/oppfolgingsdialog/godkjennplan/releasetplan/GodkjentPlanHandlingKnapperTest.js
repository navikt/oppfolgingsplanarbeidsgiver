...
import GodkjentPlanHandlingKnapper, {
  ButtonDownload,
} from '../../../../../js/components/oppfolgingsdialog/godkjennplan/releasetplan/GodkjentPlanHandlingKnapper';
...
describe('GodkjentPlanHandlingKnapper', () => {
  ...
  beforeEach(() => {
    ...
    komponentDefault = shallow(
      <GodkjentPlanHandlingKnapper oppfolgingsplan={oppfolgingsplan} apneBekreftelse={apneBekreftelse} />
    );
  });
  ...
  it('Skal kun vise 1 knapp aa laste ned plan, naar gyldighetstidspunkt er passert, det er ingen tidligere avbrutte planer, og ingen visning er valgt', () => {
    ...
    komponentDefault = shallow(
      <GodkjentPlanHandlingKnapper oppfolgingsplan={oppfolgingsplanPassert} apneBekreftelse={apneBekreftelse} />
    );
  ...
  it('Skal vise knapp for endre plan, naar gyldighetstidspunkt er passert og plan ikke plan er avbrutt', () => {
    ...
    const komponent = shallow(
      <GodkjentPlanHandlingKnapper oppfolgingsplan={oppfolgingsplanMedTidligere} apneBekreftelse={apneBekreftelse} />
    );
