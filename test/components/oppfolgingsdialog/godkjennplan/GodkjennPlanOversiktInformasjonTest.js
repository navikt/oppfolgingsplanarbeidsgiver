...
describe('GodkjennPlanOversiktInformasjon', () => {
  ...
  const komponentDefault = shallow(<GodkjennPlanOversiktInformasjon oppfolgingsdialog={oppfolgingsdialog} />);
  ...
  describe('InformasjonPanelArbeidsoppgaver', () => {
    const komponent = shallow(
      <InformasjonPanelArbeidsoppgaver arbeidsoppgaver={oppfolgingsdialog.arbeidsoppgaveListe} />
    );
  ...
  describe('InformasjonPanelArbeidsoppgaverEtterGjennomfoering', () => {
    ...
    it('Skal vise en div med informasjon per Arbeidsoppgave', () => {
      expect(komponent.find('div.godkjennPlanOversiktInformasjon__panel__arbeidsoppgave')).to.have.length(
