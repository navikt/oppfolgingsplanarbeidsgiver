...
describe('TiltakUtvidbar', () => {
  ...
  beforeEach(() => {
    ...
    komponent = mount(
      <Provider store={store}>
        <TiltakContainer element={oppfolgingsdialog.tiltakListe[0]} fnr={'1000000000000'} feilMelding={false} />
      </Provider>
    );
  });
  ...
  it('Skal vise ButtonVurdering', () => {
    ...
    komponent = mount(
      <Provider store={store}>
        <TiltakContainer element={tiltakElement} fnr={'1000000000001'} feilMelding={false} />
      </Provider>
    );
